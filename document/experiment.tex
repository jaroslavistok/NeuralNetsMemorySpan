...
Na grafe \ref{decay_errors} môžeme vidieť, že kvantizačná chyba pri hodnote parametra $\beta = 1$ je vyššia, ale nemá to negatívny 
vplyv na pamäťovú hĺbku Decay MSOM a je to z toho dôvodu, že kontext je nezávislý od stavu (natrénovanosti) siete. Môžeme tvrdiť, že kontext je 
stále rovnako kvalitný. 
...
\begin{itemize}
    \item \textbf{abcd}
    \begin{itemize}
        \item Priemerná pamäťová hĺbka: \textbf{3.14}
        \item Priemerná kvantizačná chyba: \textbf{0.87}
    \end{itemize}
    \item \textbf{reber}
    \item \begin{itemize}
        \item Priemerná pamäťová hĺbka: \textbf{2.27}
        \item Priemerná kvantizačná chyba: \textbf{0.82}
    \end{itemize}
    \item \textbf{corpus}
    \begin{itemize}
        \item Priemerná pamäťová hĺbka: \textbf{0.6}
        \item Priemerná kvantizačná chyba: \textbf{0.23}
    \end{itemize}
\end{itemize}
...
Podobne ako pri RecSOM so stúpajúcou komplexitou trénovacej množiny nám klesá hodnota pamäťovej hĺbky.
